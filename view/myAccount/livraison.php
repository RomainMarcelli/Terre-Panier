...
<body>
    ...
    <main>
        ...
        <div class="all_livraison">
            <div class="all_types">
                <div class="type_livraison">
                    <p class="expidititeur">Produit(s) expédié(s) par : Nom du producteur</p>
                    <div class="details_livraison">
                        <p>Domicile standard <span>(5 jours)</span> </p>
                        <p class="price_livraison">7,90€</p>
                    </div>
                    <div class="details_livraison">
                        <p>Domicile Express <span>(3 jours)</span></p>
                        <p class="price_livraison">8,90€</p>
                    </div>
                    <div class="details_livraison">
                        <p>Click and Collect </p>
                        <p class="price_livraison">0€</p>
                    </div>
                    <div class="total_livraison">
                        <p class="upppercase">Total</p>
                        <p class="gras">00,00€</p>
                    </div>
                    <div class="total_livraison">
                        <p>Avec frais de livraison</p>
                        <p>00,00€</p>
                    </div>
                </div>
                <hr>
                <div class="type_livraison">
                    <p class="expidititeur">Produit(s) expédié(s) par : Nom du producteur</p>
                    <div class="details_livraison">
                        <p>Domicile standard (5 jours)</p>
                        <p class="price_livraison">7,90€</p>
                    </div>
                    <div class="details_livraison">
                        <p>Domicile Express (3 jours)</p>
                        <p class="price_livraison">8,90€</p>
                    </div>
                    <div class="details_livraison">
                        <p>Click and Collect </p>
            ...
            <div class="total_frais">
                <div class="total_commande">
                    <p class="uppercase">Total de la commande</p>
                    <p class="uppercase">00,00€</p>
                </div>
                <div class="frais_livraison">
                    <p>frais de livraison</p>
                    <p>00,00€</p>
                </div>
                <div class="btn_livraison">
                    <button>Payer</button>
                </div>
            </div>
        </div>
