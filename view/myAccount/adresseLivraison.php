...
<head>
    ...
    <title>Mes adresses de livraison</title>
            ...
            <div class="complet">
                <div class="bar_filtre" id="bar_filtreLivraison">
                    <div class="trier">
                        ...
                        <a href="adresseLivraison.php">
                            <p class="gras">Mes adresses de livraison</p>
                        </a>
                        <a href="./commande.php">
                            <p>Mes commandes</p>
                        </a>
                ...
                <div class="adresse_livraison">
                    ...
                    <div class="all_adresse">
                        <div class="details_principale">
                            <p id="adresse_principale">Adresse principale</p>
                            <p>Romain Marcelli</p>
                            <p>25 rue Labois-Rouillon</p>
                            <p>75019</p>
                            <p>Paris</p>
                            <p>France</p>
                        </div>
                        <div class="details_secondaire">
                            <p id="adresse_secondaire">Adresse secondaire</p>
                            <p>Romain Marcelli</p>
                            <p>25 rue Labois-Rouillon</p>
                            <p>75019</p>
                            <p>Paris</p>
                        ...
                        <div class="btnLivraison">
                            <button>Modifier les informations</button>
                        </div>
                    </div>
                    <div class="nouvelle_adresse">
