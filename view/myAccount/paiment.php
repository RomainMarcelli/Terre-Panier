...
<body>
    ...
    <main>
        ...
        <div class="paiment">
            ...
            <div class="paiment_total">
                <div class="total_price">
                    <p class="total_commande">Total de la commande</p>
                    <div class="price">68,57€</div>
                </div>
                <div class="frais_livraison">
                    <p class="fraisLivraison">dont frais de livraison</p>
                    <p class="price">7,98€</p>
                </div>
            </div>
            <div class="carte_bancaire">
                <h3>Carte Bancaire</h3>
                <div class="card">
                    <img src="../../img/mastercard.svg" alt="Mastercard">
                    <img src="../../img/visa.svg" alt="Mastercard">
                    <img src="../../img/maetro.svg" alt="Mastercard">
                    <img src="../../img/cb.svg" alt="Mastercard">
                </div>

                <div class="infos_carte">
                    <label for="name_carte">Nom de la carte</label>
                    <input type="text" name="name_carte" id="name_carte">
                    <label for="number_carte">Numéro de carte</label>
                    <input type="text" name="number_carte" id="number_carte">
                    <div class="dateCV" id="dateCV">
                        <div class="input_date">
                            <label for="date_exp">Date d'expiration</label>
                            <input type="text" name="date_exp" id="date_exp" pattern="\d{2}/\d{2}" placeholder="MM/YY">
                        </div>
                        <div class="cvv">
                ...
                <div class="check_condit">
                    <input type="checkbox" name="" id="">
                    <p class="conditionsG">En payant, j’accepte les Conditions Générales de Vente de Terreôpanier sans réserve et j'ai pris connaissance de mon droit de rétractation.</p>
                </div>
            </div>
