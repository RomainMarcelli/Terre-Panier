...
<head>
    ...
    <link rel="stylesheet" href="/mds-back/TerreOPanier/css/fiche_atelier.css">
                        ...
                        <form action="../controller/ProductController.php?action=update&id=<?php echo $product['id']; ?>" method="POST">
                            ...
                            <div class="prix_photo">
                                <div class="prix">
                                    ...
                                    <input type="text" id="poids" name="poids" value="<?php echo htmlspecialchars($product['poids']); ?>">
                                </div>
                                <div class="photo">
                            ...
                            <div class="prix_photo">
                                ...
                                <div class="photo">
                                    ...
                                    <input type="text" name="poids_kg" id="poids_kg" value="<?php echo htmlspecialchars($product['poids_kg']); ?>">
                                </div>
                            </div>
                            <div class="photo">
                                ...
                                <span id="file-name"><?php echo htmlspecialchars($product['pictures']); ?></span>
                            </div>
                            <!-- <label for="pictures">Pictures:</label>
                            <input type="text" id="pictures" name="pictures" value="<?php // echo htmlspecialchars($product['pictures']); 
                                                                                    ?>"> -->
                            <div class="description_atelier">
                                <label for="description">Description du produit</label>
                                <textarea name="description" id="description" placeholder="Décrire le produit"><?php echo htmlspecialchars($product['description']); ?></textarea>
                            </div>
                            <div class="description_atelier">
                                <label for="caracteristique">Caracteristique</label>
                                <textarea id="caracteristique" name="caracteristique" placeholder="Décrire les caractéristiques (variété, origine, culture, utilisation, conservation...)"><?php echo htmlspecialchars($product['caracteristique']); ?></textarea>
                            </div>
                            <div class="description_atelier">
                            ...
                            <div class="description_atelier">
                                ...
                                <input type="text" id="nutri_score" name="nutri_score" value="<?php echo htmlspecialchars($product['nutri_score']); ?>">
                            </div>
                            <div class="description_atelier">
                                ...
                                <select id="category_product_id" name="category_product_id" required>
                                    ...
                                    <?php foreach ($categories as $category) : ?>
                                        <option value="<?php echo htmlspecialchars($category['id']); ?>" <?php if ($category['id'] == $product['category_product_id']) echo 'selected'; ?>>
                            ...
                            <div class="description_atelier">
                                ...
                                <input type="text" id="quantity" name="quantity" value="<?php echo htmlspecialchars($product['quantity']); ?>" required>
                            </div>
                            <div class="description_atelier">
                                <label for="producteurs_id">Producteurs ID:</label>
                                <input type="text" id="producteurs_id" name="producteurs_id" value="<?php echo htmlspecialchars($product['producteurs_id']); ?>" required>
                            </div>
                            <div class="description_atelier">
                            ...
                            <div class="description_atelier">
                                ...
                                <input type="text" id="reduction" name="reduction" value="<?php echo htmlspecialchars($product['reduction']); ?>">
                            </div>
                            <label for="category_product_id">Category Product ID:</label>
                            <select id="category_product_id" name="category_product_id" required>
                                <?php foreach ($categories as $category) : ?>
                                    <option value="<?php echo htmlspecialchars($category['id']); ?>" <?php if ($category['id'] == $product['category_product_id']) echo 'selected'; ?>>
                                        <?php echo htmlspecialchars($category['title']); ?>
