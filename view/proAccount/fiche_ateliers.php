            ...
            <div class="complet">
                ...
                <div class="fiche_atelier">
                    ...
                    <div class="link_create">
                        <a href="create_atelier.php">Créer une nouvelle fiche atelier</a>
                    </div>
                    <div class="fabrication">
                        <div class="title_price">
                            <p>Fabrication de sa tomme fraîche</p>
                            <p>40,00€</p>
                        </div>
                        <div class="lieu">
                            <p>Compiègne, Hauts-de-France</p>
                        </div>
                        <div class="description">
                            Poussez les portes de notre ferme et venez fabriquer votre tomme fraîche avec Mireille, artisane fromagère. Après une briève présentation des ...
                        </div>
                        ...
                        <div class="btn_ben">
                            <div></div>
                            <button>Modifier ma fiche</button>
                    ...
                    <div class="fabrication">
                        <div class="title_price">
                            <p>Création de son potager maison</p>
                            <p>35,00€</p>
                        </div>
                        <div class="lieu">
                            <p>Compiègne, Hauts-de-France</p>
                        ...
                        <div class="description">
                            Grâce à Pierre, vous apprendrez les techniques de maraîchage, vous construirez votre petit potager maison avec lequel vous repartirai...
                            <div class="btn_active">
                                <p>Fiche active</p>
                                <label class="switch">
                                    <input type="checkbox">
