...
<head>
    ...
    <title>Viandes & Charcuteries</title>
...
<body>
    ...
    <!-- <div class="chemin_acces">
        <p>Viande & Charcuteries <span>></span> Viandes</p>
    </div> -->

    <h2 class="title_page">Viandes & Charcuteries</h2>
    ...
    <div class="complet">
        ...
        <h2 class="hidden">Viandes & Charcuteries</h2>
        <div id="produits">
