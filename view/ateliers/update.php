            ...
            <div class="logo_burger">
                <div id="mySidenav" class="sidenav">
                    ...
                    <ul>
                        ...
                        <li class="icon_burger"><a href="../myAccount/detailsPanier.php"><img src="../../img/panier.svg" alt=""></a></li>
            ...
            <div class="complet" id="list_product">
                ...
                <div class="creationFiche_atelier">
                    ...
                    <div class="all_detail_atelier">
                        <form action="../controller/AtelierController.php?action=update&id=<?php echo $atelier['id']; ?>" method="POST">
                            <div class="name_atelier">
                                <label for="title">Nom de l'atelier</label>
                                <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($atelier['title']); ?>" required>
                            </div>
                                ...
                                <div class="regions">
                                    ...
                                    <select name="location" id="location" required>
                                        <?php foreach ($departments as $department) : ?>
                                            <option value=""><?php echo htmlspecialchars($atelier['location']); ?></option>
                            ...
                            <div class="prix_photo">
                                <div class="prix">
                                    ...
                                    <input type="text" name="price" id="price" value="<?php echo htmlspecialchars($atelier['price']); ?>" required>
                                </div>
                                <div class="photo">
                                ...
                                <input type="file" name="photo" id="photo"> -->
                                    ...
                                    <span id="file-name"><?php echo htmlspecialchars($atelier['pictures']); ?></span>
                                </div>
                            ...
                            <div class="description_atelier">
                                ...
                                <textarea name="description" id="description" placeholder="Décrire l'atelier"><?php echo htmlspecialchars($atelier['description']); ?></textarea>
                            </div>
                            <div class="temps">
                                <label for="time">Temps</label>
                                <select id="time" name="time">
                                    <option value=""><?php echo htmlspecialchars($atelier['time']); ?></option>
                            ...
                            <div class="participant">
                                ...
                                <input type="text" name="place" id="place" value="<?php echo htmlspecialchars($atelier['place']); ?>" required>
                            </div>
                            <div class="age">
                            ...
                            <div class="all_date">
                                <div class="date">
                                    ...
                                    <input type="date" name="date" id="date" value="<?php echo htmlspecialchars($atelier['date']); ?>" required>
                                </div>
                                <div class="debut">
                            ...
                            <div class="lieu">
                                <label for="producteur_id">Producteur ID</label>
                                <input type="text" id="producteur_id" name="producteur_id" value="<?php echo htmlspecialchars($atelier['producteur_id']); ?>" required>
                            </div>
                            ...
                            <select id="category_ateliers_id" name="category_ateliers_id" required>
                                <?php foreach ($categories as $category) : ?>
                                    <option value="<?php echo htmlspecialchars($category['id']); ?>" <?php if ($category['id'] == $atelier['category_ateliers_id']) echo 'selected'; ?>>
