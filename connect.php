...
<body>
    <header>
            ...
            <div class="logo_burger">
                <div id="mySidenav" class="sidenav">
                    ...
                    <ul>
                        ...
                        <li><a href="./view/productPages/fruit.html">Fruits & Légumes</a></li>
                        <li><a href="./view/productPages/viandes.html">Viande & Charcuteries</a></li>
                        <li><a href="./view/productPages/poissons.html">Poisson & Fruits de mer</a></li>
        ...
        <div class="flex" id="menu">
            <a href="./view/productPages/fruit.html">Fruits & Légumes</a>
            <a href="./view/productPages/viandes.php">Viande & Charcuteries</a>
            <a href="./view/productPages/poissons.html">Poisson & Fruits de mer</a>
