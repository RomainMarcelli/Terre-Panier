...
<body>
    ...
    <div class="chemin_acces">
        <p><span><</span>Nom de la catégorie</p>
    </div>
    ...
    <div class="leProduit">
        <div class="img_txt">
            ...
            <div class="txt">
                ...
                <h3>Nom du produit <br> et poids</h3>
                <div class="price">
                    <p>Avis client : ?/5</p>
        ...
        <div class="details">
            <div class="description">
                ...
                <p>Lorem ipsum dolor sit amet consectetur. Auctor enim eget tincidunt mattis ipsum euismod. Sit nunc sit metus tristique justo a etiam.Lorem ipsum dolor sit amet consectetur.</p>
            </div>
            <div class="caracteristique">
                <h4>Caractéristiques</h4>
                <ul>
                    <li><p>Ingrédients :</p></li>
                    <li><p>Allergènes : </p></li>
                    <li><p>Emballage :</p></li>
                    <li><p>Origine : </p></li>
